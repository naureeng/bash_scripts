...
experimentName  = 'me190503Merfish_Lib6_32x_5uM'; % provide experiment name, no spaces!

% set directories
% dataDir     = 'D:\test';        
dataDir     = '//nfs//winstor//isogai//smfish_data//disk6//Mat//'; % specify directory of data, no spaces!
thisExpDir  = fullfile(dataDir,experimentName);
ResultsDir  = '//nfs//winstor//isogai//stella//processed';  % specify output file, no spaces!
